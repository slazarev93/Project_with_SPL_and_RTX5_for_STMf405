...
#define EVENT_TIMESTAMP_SOURCE  0	// 0 - default

//   <o>Time Stamp Clock Frequency [Hz] <0-1000000000>
//   <i>Defines initial time stamp clock frequency (0 when not used)
#define EVENT_TIMESTAMP_FREQ    1000000	// 0U

#if    ((EVENT_TIMESTAMP_SOURCE == 3) || (EVENT_TIMESTAMP_SOURCE == 4))
//   <o>User Timer
//     <2=>TIM2 <0=>Coming soon 
//   <i>Defines UserTimer's time stamp clock frequency (0 when not used)
#define USER_TIM_NO    2	// 0U
#if (USER_TIM_NO == 2) 
